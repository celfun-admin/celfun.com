...
export const metadata = {
  ...
  description: "Contáctanos por WhatsApp, teléfono o envía tus comentarios y quejas de forma anónima. Atención personalizada y feedback para mejorar nuestros accesorios para celular.",
  keywords: [
    "contacto Celfun",
    "atención al cliente",
    "WhatsApp",
  ...
  openGraph: {
    title: "Contacto y Comentarios | Celfun",
    description: "Contáctanos por WhatsApp, teléfono o envía feedback anónimo. Atención personalizada para todas tus consultas.",
    url: "https://celfun.com/contacto",
  },
  twitter: {
    title: "Contacto y Comentarios | Celfun",
    description: "Contáctanos por WhatsApp, teléfono o envía feedback anónimo sobre nuestros accesorios para celular.",
  }
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form - Order changes on mobile */}
          ...
          <div className="order-1 lg:order-2 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-3">
                ...
                <a
                  href="https://wa.me/527776819300"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors group"
                >
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-900">Reparaciones de Teléfonos</h4>
            ...
            {/* Phone Section */}
            <div className="order-2 bg-white rounded-2xl shadow-xl p-8">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Llámanos</h3>
              </div>
          ...
          {/* Social Media Section - Separate container for mobile ordering */}
          <div className="order-4 lg:order-2 lg:col-start-2">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="flex items-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Redes Sociales</h3>
              </div>
              <p className="text-gray-600 mb-6">Síguenos y mantente al día con las últimas noticias y actualizaciones.</p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a
                  href="https://www.facebook.com/CelfunMEX"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.instagram.com/celfunmx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center p-4 bg-pink-50 rounded-lg hover:bg-pink-100 transition-colors group"
                >
                  <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mb-2 group-hover:scale-110 transition-transform">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
